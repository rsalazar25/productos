...
function inicio(){
	$(".link2").click(anade);
	$('#carrito-compras-tienda').load("private/carrito.php");
...
function anade(){
	...
	//alert(idnumero);
	//alert(elId);
	$('#carrito-compras-tienda').load("private/carrito.php?prod="+$(this).val()+"&id="+elId);
	$('.suma').load("private/requisitor-carrito-suma.php?prod3="+$(this).val()+"&id="+elId);
